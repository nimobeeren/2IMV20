...
In recent years, it has become increasingly clear to most people that climate change is affecting life on earth \cite{TODO}. As temperatures rise globally, many animals are forced to adapt to their environment \cite{TODO}. Among the best-documented instances of such adaptation are changes in bird migration times \cite{TODO}. This is in part due to the large amount of citizen science data that have been recorded \cite{TODO}. This paper presents an interactive visualization to communicate these findings.
