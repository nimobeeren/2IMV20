...
\paragraph{How are temperature and the timing of bird migration correlated?}

One of the things that a user can do with the application is to find the correlation between the changes in temperature and the timing of bird migrations. For this task the best approach the user can take is to choose the yearly view. The user can choose a specific bird species with which to visualize the correlation, but the default one - Barn Swallow - is the one that shows the correlation most clearly.  An important choice that the user has to make is which month they want to look at as some months are better for showcasing the movement of birds because it is dependant on the time of the year. For example March is associated with the migrations of most birds to the North. After a month has been chosen the user can go through different years where for each year only the chosen month will be displayed  in both the temperature and the bird migration maps. In this way the user can see how the bird movement has changed over the span of several years while being able to see the changes in temperatures for the same amount of time. An example visualization can be seen on Fig. \ref{fig:swallow-map-86} and Fig. \ref{fig:swallow-map-16}.

\begin{figure}[h]
  \centering
  \includegraphics[width=70mm]{march86-map-barnswallow}
  \caption{Visualization of maps of temperature anomaly and Barn Swallow latitude porsition for March 1986.}
  \label{fig:swallow-map-86}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=70mm]{march16-map-barnswallow}
  \caption{Visualization of maps of temperature anomaly and Barn Swallow latitude porsition for March 2016.}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=70mm]{march86-16-graph-barnswallow}
  \caption{Visualization of line grarh showing of temperature anomaly and Barn Swallow latitude porsition for March 1986 to 2016.}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=70mm]{montly-graph16-barnswallow}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=70mm]{march16-map-blackbird}
