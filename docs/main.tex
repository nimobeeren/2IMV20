...
To implement the ray composite function, we went for a front-to-back compositing strategy. This strategy uses a similar formula to the one studied in class \citep{2imv20_2} (back-to-front compositing):
...
The implementation of Phong's shading model can be found in the method {\tt computePhongShading} of class {\tt RaycastRenderer} and follows the standard formula given during the classes \citep{2imv20_2}:
