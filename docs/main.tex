...
Working on this assigment provided us experience and insight on the inner workings of some volume rendering methods, namely MIP, compositing, isosurface and 2D transfer. Each method has its own advantages and disadvantes as discussed in \autoref{discussion}.

Regarding lighting, we also had the opportunity of implementing the standard Phong's shading model, which gave us a deeper understanding on how light works in 3D environments.
