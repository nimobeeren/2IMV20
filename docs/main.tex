...
Isosurface raycasting is most useful when the region we want to visualize has much higher intensity than the material around it, for example flesh vs. air.
