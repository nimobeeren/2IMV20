...
In class, we have discussed various rendering methods used to visualize 3D scalar data \citep{2imv20_2}. In this report, we describe our implementation of these methods and compare them by visualizing various datasets.
